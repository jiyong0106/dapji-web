...
const Privacypage = () => {
  return (
    <div className={cn('container')}>
      <h1>DAPJI 개인정보 보호정책</h1>
      <p>
        <strong>DAPJI</strong> (이하 “회사”라고 함)은(는) 이용자들의
      ...
      <div className={cn('section-content')}>
        ...
        <ol>
          <li>
            ...
            <br />
            이메일, 휴대전화번호, 비밀번호, 로그인ID, 생년월일, ci(연계정보),
            di(중복가입정보), 닉네임, 이름, 서비스 이용 기록, 접속 로그, 쿠키,
            접속 IP 정보, 고객센터 이용 시 내용
          </li>
          <li>
      ...
      <div className={cn('section-content')}>
        ...
        <ol>
          ...
          <li>
            3. DAPJI는 위탁계약 체결 시 「개인정보 보호법」 제26조에 따라
